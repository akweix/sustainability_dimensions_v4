...
<div style="background-image: url('https://media.wired.com/photos/60be3c2f70d107b3e767d5a1/master/w_1600,c_limit/AdobeStock_377847107.jpeg'); background-size: cover; background-position: center center; height: 100%; width: 100%; display: flex; justify-content: center; align-items: center; text-align: center;">

  <h1 style="color: white; font-size: 2em;">Visualization of Swiss Stocks Sustainability</h1>
  <h2 style="color: white; font-size: 1em;">Sean Anum</h2>
...
p_3d <- layout(p_3d,
               title = "Stocks on the Swiss Stock Exchange SIX",
